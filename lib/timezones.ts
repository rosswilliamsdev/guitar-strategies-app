...
export const COMMON_TIMEZONES: TimezoneOption[] = [
  ...
  // Canada
  { value: 'America/Toronto', label: 'Eastern Time (Toronto)', group: 'Canada' },
  { value: 'America/Winnipeg', label: 'Central Time (Winnipeg)', group: 'Canada' },
  { value: 'America/Edmonton', label: 'Mountain Time (Edmonton)', group: 'Canada' },
  { value: 'America/Vancouver', label: 'Pacific Time (Vancouver)', group: 'Canada' },
  ...
  // Asia Pacific
  { value: 'Asia/Tokyo', label: 'Japan Standard Time (JST)', group: 'Asia Pacific' },
  { value: 'Asia/Shanghai', label: 'China Standard Time (CST)', group: 'Asia Pacific' },
  { value: 'Asia/Seoul', label: 'Korea Standard Time (KST)', group: 'Asia Pacific' },
  { value: 'Asia/Singapore', label: 'Singapore Standard Time (SGT)', group: 'Asia Pacific' },
  { value: 'Australia/Sydney', label: 'Australian Eastern Time (AEDT)', group: 'Asia Pacific' },
  { value: 'Australia/Melbourne', label: 'Australian Eastern Time (Melbourne)', group: 'Asia Pacific' },
  ...
  { value: 'America/Mexico_City', label: 'Central Standard Time (Mexico)', group: 'North America' },
];
